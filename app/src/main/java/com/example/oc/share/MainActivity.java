...
import com.example.oc.share.DeviceListFragment.DeviceActionListener;
/**
...
public class MainActivity extends AppCompatActivity implements ChannelListener, DeviceActionListener {
    ...
    public void onResume() {
        super.onResume();
        receiver = new wifireciever(manager, channel, this);
    ...
    public void resetData() {
        ...
        DeviceDetailFragment fragmentDetails = (DeviceDetailFragment) getFragmentManager().findFragmentById(R.id.fragment_detail);
